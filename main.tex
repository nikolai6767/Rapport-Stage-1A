...
% TODO
% Standard macros
\title{Analyse et Optimisation des performances d'un nouveau format de trace, Pallas, pour les architectures de calcul exascale} % Sujet du stage
\author{Nikolaï MONTICELLI} % Prénom NOM de l'étudiant(e)
\date{17 juin 2025 au 29 août 2025} % Dates du stage
