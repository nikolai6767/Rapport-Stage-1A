...
\documentclass[language=fr, year=1A, enterprise=ensIIE]{ensiie-report}
...
\date{du 17 juin 2025 au 29 août 2025} % Dates du stage
...
\internshipEnterprise{Télécom SudParis (Évry-Courcouronnes, 91)} % Lieu du stage
...
\input{sub/010_remerciements.tex}
\newpage
...
\input{sub/100_introduction.tex}
\newpage
...
\input{sub/120_travaux_realises.tex}
\newpage
...
\input{sub/210_organisation.tex}
\newpage
...
\input{sub/220_details_techniques.tex}
\newpage
